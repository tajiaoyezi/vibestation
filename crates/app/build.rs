...
use vibestation_core::{
    LayoutState, TabCloseRequest, TabCreateRequest, TabListResponse, TabRenameRequest, TabState,
    WorkspaceMetadata,
};
...
fn main() {
    ...
    fs::write(
        ...
        [
            ...
            "// Source of truth: crates/core/src/workspace.rs · layout.rs · tabs.rs (SPIKE-08 §A rollout).",
