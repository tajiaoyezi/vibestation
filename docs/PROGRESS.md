...
- 治理：全 v2-D.2 trailer + §2.15 fetch+rebase + §2.14 runtime verify · 0 author 污染 · CI=workflow_dispatch（无 auto-CI · 已用真集成态全 gate 替代 · 规则漂移待 Arbiter）
