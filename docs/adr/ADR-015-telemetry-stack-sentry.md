...
**状态**：accepted
**日期**：2026-04-25
**决策者**：Codex CLI（Spike 作者）· tajiaoyezi（Arbiter 拍板 via PR #152）
...
**选择**：选项 A · `sentry` crate 0.47.0，但只作为 opt-in crash transport 使用。
...
- 2026-04-26 · accepted by Arbiter · PR #152 · Kimi
