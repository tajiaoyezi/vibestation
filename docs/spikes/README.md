...
| SPIKE-07   | CLI 输出协议 parser 验证        | **ready**（session 32 ready-gate：3 High 修 @ PR #328 · re-review APPROVE-WITH-NITS · threshold 收敛 + Arbiter approve flip @ PR #331） | —（未启动 · 实跑待排期）                    | ADR-017 ai-aware-greenlight（未来 · 见 [ADR-009](../adr/ADR-009-ai-aware-v1-vision.md)） | MVP-18 / MVP-19 / MVP-20          | 未启动                                        |
