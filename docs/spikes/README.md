...
| SPIKE-07   | CLI 输出协议 parser 验证        | **draft**（session 31 详化完成 PR #311 · session 32 ready-gate 修 3 阻塞） | —（未启动）                                 | ADR-017 ai-aware-greenlight（未来 · 见 [ADR-009](../adr/ADR-009-ai-aware-v1-vision.md)） | MVP-18 / MVP-19 / MVP-20          | 未启动                                        |
