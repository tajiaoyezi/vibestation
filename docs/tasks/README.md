...
| MVP-19     | session ↔ commit 绑定                     | **in-progress** | session 32 ready-gate + 05-17 Arbiter waive MVP-18-done gate（#365）· **W1-A.0/A.1/B + W2-A.0 + W2-C merged**（types/DAO/engine + IPC contract+bindings + 前端 client #366-#370）· **W2-B（Codex）/ W2-D（Droid）+ W2-doc 并行 in flight** · Phase C/D/E 待续 · owner Claude Code | #313 · #330 · #365-#370   |
