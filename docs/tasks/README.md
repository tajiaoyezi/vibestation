...
| [MVP-05](./MVP-05-pane-split-single-level.md)      | Pane 分屏（单层 · 最多 4 Pane · Smart Layouts）                | ready（spec PR #74 · Phase A/B/C 全 done · PR #141-#151 序列 + lifecycle bug 修 PR #208 · 集成完整 · 代码已集成完整，根据 [ADR-023](../../docs/adr/ADR-023-capture-mandate-removed.md) 已弃用 capture 截图归档要求，status 已于 PR #405 done）                                                                                                                                  | 4d   | MVP-04               |
