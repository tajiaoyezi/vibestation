...
| MVP-18   | AI-Aware Pane 联动         | **ready** | session 32 Arbiter approve flip（实施仍 gated on SPIKE-07 + MVP-14）   | #309 · #329 |
| MVP-19   | session ↔ commit 绑定      | **ready** | session 32 Arbiter approve flip（实施仍 gated on MVP-18 done）         | #313 · #329 |
| MVP-20   | 一键回滚（session revert） | **ready** | session 32 Arbiter approve flip（实施仍 gated on MVP-19 done）         | #312 · #329 |
...
| [MVP-18](./MVP-18-ai-aware-pane-linking.md)         | **AI-Aware Pane 联动**（v1.0 vision · 对外禁提）                    | **ready**（session 31 详化 100% · 611 行 · 48 checkbox · Codex CLI PR #309 · session 32 Arbiter approve flip + MVP-14 wording nit 修 PR #329 · 实施仍 gated on SPIKE-07 PASS + MVP-14 全 phase done）                                                                                                                                                   | v1.0     | 15d  | MVP-14 · SPIKE-07        |
| [MVP-19](./MVP-19-session-commit-binding.md)        | **AI session ↔ commit 自动绑定**（v1.0 vision）                     | **ready**（session 31 详化 100% · 740 行 · 43 checkbox · Cursor PR #313 · session 32 Arbiter approve flip + §B/§H1 nit 修 PR #329 · 实施仍 gated on MVP-18 done）                                                                                                                                                                                       | v1.0     | 8d   | MVP-18                   |
| [MVP-20](./MVP-20-ai-one-click-rollback.md)         | **AI 一键回滚（session 级 revert）**（v1.0 vision）                 | **ready**（session 31 详化 100% · 647 行 · 25 checkbox + 12 sub · Droid PR #312 · session 32 Arbiter approve flip + §B.2 三处接口锚定 + §H.7 nit 修 PR #329 · 实施仍 gated on MVP-19 done）                                                                                                                                                             | v1.0     | 6d   | MVP-19                   |
